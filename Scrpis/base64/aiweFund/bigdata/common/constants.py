...
CN_STOCK_A_dic = {'fs_operating_revenue_qoq_0': 'financial_statement_ff_CN_STOCK_A',
                  'pe_lyr': 'market_value_CN_STOCK_A', 'chibor_3M': 'macrodata',
                  'fs_net_profit_ttm_0': 'financial_statement_ff_CN_STOCK_A', 'chibor_1Y': 'macrodata',
                  'ppi': 'macrodata', 'company_province': 'basic_info_CN_STOCK_A',
                  ...
                  'fs_quarter_year_0': 'financial_statement_ff_CN_STOCK_A', 'volume': 'bar1d_CN_STOCK_A',
                  'fs_capital_reserves': 'financial_statement_CN_STOCK_A',
                  'fs_surplus_reserves': 'financial_statement_CN_STOCK_A',
                  'fs_deducted_profit_0': 'financial_statement_ff_CN_STOCK_A', 'mf_net_amount': 'net_amount_CN_STOCK_A',
                  'fs_current_liabilities_0': 'financial_statement_ff_CN_STOCK_A',
                  'fs_total_equity_0': 'financial_statement_ff_CN_STOCK_A', 'close': 'bar1d_CN_STOCK_A',
                  'pmi': 'macrodata', 'chibor_2w': 'macrodata', 'mf_net_pct_l': 'net_amount_CN_STOCK_A',
                  'concept': 'industry_CN_STOCK_A', 'fs_eps_yoy_0': 'financial_statement_ff_CN_STOCK_A',
                  'chibor_3w': 'macrodata', 'fs_roe': 'financial_statement_CN_STOCK_A',
                  'fs_deducted_profit': 'financial_statement_CN_STOCK_A',
                  'fs_common_equity': 'financial_statement_CN_STOCK_A', 'fs_roa_ttm': 'financial_statement_CN_STOCK_A',
                  'price_limit_status': 'stock_status_CN_STOCK_A', 'in_csi500': 'index_constituent_CN_STOCK_A',
                  'fs_bps_0': 'financial_statement_ff_CN_STOCK_A',
                  'fs_current_assets': 'financial_statement_CN_STOCK_A', 'fs_eps': 'financial_statement_CN_STOCK_A',
                  'fs_cash_ratio_0': 'financial_statement_ff_CN_STOCK_A', 'mf_net_pct_main': 'net_amount_CN_STOCK_A',
                  'fs_roe_ttm': 'financial_statement_CN_STOCK_A', 'fs_net_profit_qoq': 'financial_statement_CN_STOCK_A',
                  'list_date': 'basic_info_CN_STOCK_A', 'foreign_exchange_reserve': 'macrodata',
                  'amount': 'bar1d_CN_STOCK_A', 'fs_total_profit_0': 'financial_statement_ff_CN_STOCK_A',
                  'fs_proj_matl_0': 'financial_statement_ff_CN_STOCK_A',
                  'fs_income_tax': 'financial_statement_CN_STOCK_A',
                  'fs_quarter_index': 'financial_statement_CN_STOCK_A', 'mf_net_pct_s': 'net_amount_CN_STOCK_A',
                  'suspended': 'stock_status_CN_STOCK_A', 'ps_ttm': 'market_value_CN_STOCK_A',
                  'fs_net_cash_flow_ttm': 'financial_statement_CN_STOCK_A', 'pe_ttm': 'market_value_CN_STOCK_A',
                  'fs_quarter_index_0': 'financial_statement_ff_CN_STOCK_A',
                  'fs_total_operating_costs': 'financial_statement_CN_STOCK_A',
                  'fs_account_payable': 'financial_statement_CN_STOCK_A', 'industry_sw_level3': 'industry_CN_STOCK_A',
                  ...
                  'fs_roa_0': 'financial_statement_ff_CN_STOCK_A', 'fs_fixed_assets': 'financial_statement_CN_STOCK_A',
                  'fs_net_profit_margin_ttm_0': 'financial_statement_ff_CN_STOCK_A',
                  'fs_operating_revenue_0': 'financial_statement_ff_CN_STOCK_A',
                  'fs_publish_date': 'financial_statement_CN_STOCK_A', 'mf_net_amount_l': 'net_amount_CN_STOCK_A',
                  'fs_capital_reserves_0': 'financial_statement_ff_CN_STOCK_A',
                  'fs_current_assets_0': 'financial_statement_ff_CN_STOCK_A',
                  'in_csi100': 'index_constituent_CN_STOCK_A', 'company_name': 'basic_info_CN_STOCK_A',
                  'fs_publish_date_0': 'financial_statement_ff_CN_STOCK_A', 'west_eps_ftm': 'west_CN_STOCK_A',
                  'chibor_1M': 'macrodata', 'fs_construction_in_process': 'financial_statement_CN_STOCK_A',
                  'fs_net_cash_flow_ttm_0': 'financial_statement_ff_CN_STOCK_A',
                  'fs_net_profit_yoy_0': 'financial_statement_ff_CN_STOCK_A',
                  'industry_sw_level2': 'industry_CN_STOCK_A', 'cpi': 'macrodata',
                  'fs_operating_profit': 'financial_statement_CN_STOCK_A',
                  'fs_non_current_assets_0': 'financial_statement_ff_CN_STOCK_A', 'chibor_1w': 'macrodata',
                  ...
                  'fs_general_expenses': 'financial_statement_CN_STOCK_A', 'end_investor_num': 'macrodata',
                  'adjust_factor': 'bar1d_CN_STOCK_A', 'fs_net_cash_flow': 'financial_statement_CN_STOCK_A',
                  'sh_holder_avg_pct_3m_chng_0': 'financial_statement_ff_CN_STOCK_A',
                  'fs_gross_revenues_0': 'financial_statement_ff_CN_STOCK_A',
                  'fs_net_profit_0': 'financial_statement_ff_CN_STOCK_A', 'market_cap_float': 'market_value_CN_STOCK_A',
                  'in_szse100': 'index_constituent_CN_STOCK_A', 'sh_holder_num_0': 'financial_statement_ff_CN_STOCK_A',
                  'mf_net_amount_m': 'net_amount_CN_STOCK_A', 'sh_holder_avg_pct': 'financial_statement_CN_STOCK_A',
                  'deal_number': 'bar1d_CN_STOCK_A', 'low': 'bar1d_CN_STOCK_A',
                  'fs_net_profit_margin_ttm': 'financial_statement_CN_STOCK_A',
                  'mf_net_pct_xl': 'net_amount_CN_STOCK_A',
                  'fs_account_receivable_0': 'financial_statement_ff_CN_STOCK_A', 'm2': 'macrodata',
                  'company_found_date': 'basic_info_CN_STOCK_A',
                  'fs_paicl_up_capital': 'financial_statement_CN_STOCK_A',
                  'fs_total_profit': 'financial_statement_CN_STOCK_A', 'm0': 'macrodata',
                  'in_csi300': 'index_constituent_CN_STOCK_A', 'fs_roe_ttm_0': 'financial_statement_ff_CN_STOCK_A',
                  'gdp': 'macrodata', 'in_sse180': 'index_constituent_CN_STOCK_A', 'turn': 'bar1d_CN_STOCK_A',
                  'fs_roa': 'financial_statement_CN_STOCK_A', 'in_sse50': 'index_constituent_CN_STOCK_A',
                  ...
                  'fs_operating_revenue_qoq': 'financial_statement_CN_STOCK_A', 'mf_net_pct_m': 'net_amount_CN_STOCK_A',
                  ...
                  'fs_selling_expenses_0': 'financial_statement_ff_CN_STOCK_A', 'chibor_on': 'macrodata',
                  'bdi': 'macrodata', 'fs_undistributed_profit': 'financial_statement_CN_STOCK_A',
                  'fs_free_cash_flow_0': 'financial_statement_ff_CN_STOCK_A', 'gold_reserve': 'macrodata',
                  'west_avgcps_ftm': 'west_CN_STOCK_A', 'fs_current_liabilities': 'financial_statement_CN_STOCK_A',
                  'chibor_9M': 'macrodata', 'west_netprofit_ftm': 'west_CN_STOCK_A',
                  ...
                  'sh_holder_num': 'financial_statement_CN_STOCK_A', 'fs_eps_0': 'financial_statement_ff_CN_STOCK_A',
                  'sh_holder_avg_pct_0': 'financial_statement_ff_CN_STOCK_A',
                  'fs_bps': 'financial_statement_CN_STOCK_A', 'fs_net_profit': 'financial_statement_CN_STOCK_A',
                  'fs_financial_expenses_0': 'financial_statement_ff_CN_STOCK_A',
                  'fs_operating_profit_0': 'financial_statement_ff_CN_STOCK_A', 'm1': 'macrodata',
                  ...
                  'fs_non_current_liabilities_0': 'financial_statement_ff_CN_STOCK_A', 'chibor_6M': 'macrodata',
                  'fs_net_profit_yoy': 'financial_statement_CN_STOCK_A', 'chibor_2M': 'macrodata',
                  'open': 'bar1d_CN_STOCK_A', 'new_investors_num': 'macrodata',
                  'mf_net_amount_main': 'net_amount_CN_STOCK_A', 'fs_quarter_0': 'financial_statement_ff_CN_STOCK_A',
                  ...
                  'fs_non_current_liabilities': 'financial_statement_CN_STOCK_A', 'list_board': 'basic_info_CN_STOCK_A',
                  'fs_eqy_belongto_parcomsh_0': 'financial_statement_ff_CN_STOCK_A',
                  'company_type': 'basic_info_CN_STOCK_A', 'market_cap': 'market_value_CN_STOCK_A',
                  'fs_paicl_up_capital_0': 'financial_statement_ff_CN_STOCK_A', 'high': 'bar1d_CN_STOCK_A',
                  'fs_total_equity': 'financial_statement_CN_STOCK_A',
                  'sh_holder_avg_pct_6m_chng_0': 'financial_statement_ff_CN_STOCK_A',
                  'fs_gross_profit_margin': 'financial_statement_CN_STOCK_A', 'chibor_4M': 'macrodata',
                  'delist_date': 'basic_info_CN_STOCK_A', 'fs_total_liability_0': 'financial_statement_ff_CN_STOCK_A',
                  ...
                  'sh_holder_avg_pct_3m_chng': 'financial_statement_CN_STOCK_A', 'st_status': 'stock_status_CN_STOCK_A',
                  'sh_holder_avg_pct_6m_chng': 'financial_statement_CN_STOCK_A', 'pb_lf': 'market_value_CN_STOCK_A',
                  'mf_net_amount_s': 'net_amount_CN_STOCK_A'}
CN_FUTURE_dic = {'open_intl': 'bar1d_CN_FUTURE', 'close': 'bar1d_CN_FUTURE', 'list_date': 'basic_info_CN_FUTURE',
                 'dominant': 'dominant_CN_FUTURE', 'high': 'bar1d_CN_FUTURE', 'amount': 'bar1d_CN_FUTURE',
                 'volume': 'bar1d_CN_FUTURE', 'delist_date': 'basic_info_CN_FUTURE', 'low': 'bar1d_CN_FUTURE',
                 'symbol': 'basic_info_CN_FUTURE', 'settle': 'bar1d_CN_FUTURE', 'open': 'bar1d_CN_FUTURE'}
CN_FUND_dic = {'amount': 'bar1d_CN_FUND', 'close': 'bar1d_CN_FUND', 'unit_net_value': 'extras_CN_FUND',
               'avg': 'bar1d_CN_FUND', 'list_date': 'basic_info_CN_FUND', 'paused': 'bar1d_CN_FUND',
               'adjust_factor': 'bar1d_CN_FUND', 'display_name': 'basic_info_CN_FUND', 'volume': 'bar1d_CN_FUND',
               'open': 'bar1d_CN_FUND', 'delist_date': 'basic_info_CN_FUND', 'pre_close': 'bar1d_CN_FUND',
               'acc_net_value': 'extras_CN_FUND', 'name': 'basic_info_CN_FUND', 'type': 'basic_info_CN_FUND',
               'high': 'bar1d_CN_FUND', 'low_limit': 'bar1d_CN_FUND', 'low': 'bar1d_CN_FUND',
