...
@router.get("/stock/stock", response_model=ResponseSchema)
async def view_stock(
    ...
    res = view_stock.loc[(query.page - 1) * query.page_size : query.page * query.page_size - 1]
    return ResponseSchema(data=res.to_dict(orient="records"))
