...
#     """
#     return pytz.timezone(site.get("site.timezone", default="Asia/Shanghai"))
...
#     """
#     should_convert = isinstance(value, datetime) and not is_naive(value) and getattr(value, "convert_to_local_time", True)
