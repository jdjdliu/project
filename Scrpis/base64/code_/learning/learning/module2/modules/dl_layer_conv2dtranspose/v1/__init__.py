...
bigquant_friendly_name = "Conv2DTranspose层"
...
def bigquant_run(
    ...
    dilation_rate: I.str("dilation_rate，整数或由2个整数构成的list/tuple，指定dilated convolution中的膨胀比例。任何不为1的dilation_rate均与任何不为1的strides均不兼容。") = "1,1",
