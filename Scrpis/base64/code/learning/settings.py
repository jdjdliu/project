...
CUSTOM_MODULE_COLLECTION = OSEnv.str("CUSTOM_MODULE_COLLECTION", "module_metadata")
CUSTOM_MODULE_IMP_FILE = OSEnv.str("CUSTOM_MODULE_IMP_FILE", "custom_module_imp.py")
