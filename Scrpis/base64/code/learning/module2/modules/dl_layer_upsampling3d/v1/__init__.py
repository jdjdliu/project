...
bigquant_friendly_name = "UpSampling3D层"
bigquant_doc_url = "https://bigquant.com/docs/"


def bigquant_run(
    size: I.str("size，长为3的列表，分别为行和列上采样因子。列表用英文逗号(,)分隔的整数列表，例如 10 或者 32,24") = "2,2,2",
    ...
    layer = UpSampling3D(size=size, data_format=data_format)
