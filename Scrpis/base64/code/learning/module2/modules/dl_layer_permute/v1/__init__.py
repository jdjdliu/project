...
bigquant_friendly_name = "Permute层"
bigquant_doc_url = "https://bigquant.com/docs/"


def bigquant_run(
    dims: I.str("dims, 指定重排的模式，不包含样本数的维度。重拍模式的下标从1开始。例如 2,1 代表将输入的第二个维度重拍到输出的第一个维度，而将输入的第一个维度重排到第二个维度，用英文逗号(,)分隔的整数列表，例如 32,24"),
