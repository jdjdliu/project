...
# log = logbook.Logger('random_forest_regressor')
log = BigLogger("random_forest_regressor")
bigquant_cacheable = True
# 模块接口定义
bigquant_category = r"机器学习\回归"
bigquant_friendly_name = "随机森林-回归"
bigquant_doc_url = "https://bigquant.com/docs/develop/modules/random_forest_regressor.html"
...
def _train(training_ds, features, train_parameters, other_train_parameters):
    outputs = feature_train(
        training_ds=training_ds,
        features=features,
        train_algorithm=RandomForestRegressor,
...
if __name__ == "__main__":
    ...
    m2 = M.random_forest_regressor.v1(
