...
class ModuleClient:
    ...
    class API:
        ...
        CUSTOM_MODULES_V2 = "/api/userservice/module/v2/module/custom"
        CUSTOM_IS_VALID_V2 = "/api/userservice/module/v2/module/module_is_valid/{module_name}"
    ...
    def create_or_update(
        cls: Type["ModuleClient"],
        params: CreateCustomModuleRequest,
        credential: Credential,
    ) -> Any:
        response = cls.HttpClient.post(cls.API.CUSTOM_MODULES_V2, payload=params.dict(), credential=credential)
        return response

    @classmethod
    def list(cls: Type["ModuleClient"], credential: Credential) -> List[Any]:
        response: List[Any] = cls.HttpClient.get(cls.API.CUSTOM_MODULES_V2, credential=credential)
        return response

    @classmethod
    def module_is_valid(cls: Type["ModuleClient"], module_name: str, credential: Credential) -> bool:
        response: bool = cls.HttpClient.get(cls.API.CUSTOM_IS_VALID_V2.format(module_name=module_name), credential=credential)
        return response
