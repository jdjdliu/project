...
from .common import AlphaParameter, CompositionAlpha, FundAlphaParameter, IndexParameter
...
class UpdateBacktestRequest(BaseModel):
    ...
    parameter: Optional[Union[AlphaParameter, FundAlphaParameter]] = Field(default=None)
